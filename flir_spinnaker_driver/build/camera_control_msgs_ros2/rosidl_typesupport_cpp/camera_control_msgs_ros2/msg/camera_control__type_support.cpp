...
static const _CameraControl_type_support_symbol_names_t _CameraControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_control_msgs_ros2, msg, CameraControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_control_msgs_ros2, msg, CameraControl)),
  }
};
...
{
  return &::camera_control_msgs_ros2::msg::rosidl_typesupport_cpp::CameraControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, camera_control_msgs_ros2, msg, CameraControl)() {
  return get_message_type_support_handle<camera_control_msgs_ros2::msg::CameraControl>();
}
