...
{
  new (message_memory) camera_control_msgs_ros2::msg::CameraControl(_init);
}

void CameraControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<camera_control_msgs_ros2::msg::CameraControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraControl_message_member_array[3] = {
  {
    ...
    offsetof(camera_control_msgs_ros2::msg::CameraControl, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(camera_control_msgs_ros2::msg::CameraControl, exposure_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(camera_control_msgs_ros2::msg::CameraControl, gain),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CameraControl_message_members = {
  "camera_control_msgs_ros2::msg",  // message namespace
  "CameraControl",  // message name
  3,  // number of fields
  sizeof(camera_control_msgs_ros2::msg::CameraControl),
...
{
  return &::camera_control_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::CameraControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_control_msgs_ros2, msg, CameraControl)() {
  return &::camera_control_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::CameraControl_message_type_support_handle;
}
