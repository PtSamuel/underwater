...
bool camera_control_msgs_ros2__msg__camera_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("camera_control_msgs_ros2.msg._camera_control.CameraControl", full_classname_dest, 58) == 0);
  }
  camera_control_msgs_ros2__msg__CameraControl * ros_message = _ros_message;
  {  // header
...
PyObject * camera_control_msgs_ros2__msg__camera_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("camera_control_msgs_ros2.msg._camera_control");
