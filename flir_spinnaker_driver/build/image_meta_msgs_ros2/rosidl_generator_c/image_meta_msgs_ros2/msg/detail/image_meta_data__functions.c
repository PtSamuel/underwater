...
image_meta_msgs_ros2__msg__ImageMetaData__init(image_meta_msgs_ros2__msg__ImageMetaData * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    image_meta_msgs_ros2__msg__ImageMetaData__fini(msg);
    return false;
  }
  // camera_time
  // brightness
...
image_meta_msgs_ros2__msg__ImageMetaData__create()
{
  ...
  image_meta_msgs_ros2__msg__ImageMetaData * msg = (image_meta_msgs_ros2__msg__ImageMetaData *)allocator.allocate(sizeof(image_meta_msgs_ros2__msg__ImageMetaData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(image_meta_msgs_ros2__msg__ImageMetaData));
  bool success = image_meta_msgs_ros2__msg__ImageMetaData__init(msg);
  if (!success) {
...
image_meta_msgs_ros2__msg__ImageMetaData__Sequence__init(image_meta_msgs_ros2__msg__ImageMetaData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  image_meta_msgs_ros2__msg__ImageMetaData * data = NULL;

  if (size) {
    data = (image_meta_msgs_ros2__msg__ImageMetaData *)allocator.zero_allocate(size, sizeof(image_meta_msgs_ros2__msg__ImageMetaData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = image_meta_msgs_ros2__msg__ImageMetaData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        image_meta_msgs_ros2__msg__ImageMetaData__fini(&data[i - 1]);
      }
...
image_meta_msgs_ros2__msg__ImageMetaData__Sequence__fini(image_meta_msgs_ros2__msg__ImageMetaData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      image_meta_msgs_ros2__msg__ImageMetaData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  image_meta_msgs_ros2__msg__ImageMetaData__Sequence * array = (image_meta_msgs_ros2__msg__ImageMetaData__Sequence *)allocator.allocate(sizeof(image_meta_msgs_ros2__msg__ImageMetaData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = image_meta_msgs_ros2__msg__ImageMetaData__Sequence__init(array, size);
  if (!success) {
...
image_meta_msgs_ros2__msg__ImageMetaData__Sequence__destroy(image_meta_msgs_ros2__msg__ImageMetaData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    image_meta_msgs_ros2__msg__ImageMetaData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
image_meta_msgs_ros2__msg__ImageMetaData__Sequence__are_equal(const image_meta_msgs_ros2__msg__ImageMetaData__Sequence * lhs, const image_meta_msgs_ros2__msg__ImageMetaData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!image_meta_msgs_ros2__msg__ImageMetaData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  image_meta_msgs_ros2__msg__ImageMetaData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(image_meta_msgs_ros2__msg__ImageMetaData);
    image_meta_msgs_ros2__msg__ImageMetaData * data =
      (image_meta_msgs_ros2__msg__ImageMetaData *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!image_meta_msgs_ros2__msg__ImageMetaData__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          image_meta_msgs_ros2__msg__ImageMetaData__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!image_meta_msgs_ros2__msg__ImageMetaData__copy(
