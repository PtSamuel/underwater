...
static const _ImageMetaData_type_support_symbol_names_t _ImageMetaData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, image_meta_msgs_ros2, msg, ImageMetaData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_meta_msgs_ros2, msg, ImageMetaData)),
  }
};
...
{
  return &::image_meta_msgs_ros2::msg::rosidl_typesupport_cpp::ImageMetaData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, image_meta_msgs_ros2, msg, ImageMetaData)() {
  return get_message_type_support_handle<image_meta_msgs_ros2::msg::ImageMetaData>();
}
