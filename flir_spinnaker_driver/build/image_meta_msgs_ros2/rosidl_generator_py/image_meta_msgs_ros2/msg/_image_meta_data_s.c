...
bool image_meta_msgs_ros2__msg__image_meta_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("image_meta_msgs_ros2.msg._image_meta_data.ImageMetaData", full_classname_dest, 55) == 0);
  }
  image_meta_msgs_ros2__msg__ImageMetaData * ros_message = _ros_message;
  {  // header
...
PyObject * image_meta_msgs_ros2__msg__image_meta_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("image_meta_msgs_ros2.msg._image_meta_data");
